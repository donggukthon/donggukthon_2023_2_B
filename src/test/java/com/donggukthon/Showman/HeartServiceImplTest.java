...
////    }
//
//    public  void heartCountIncrease(Heart heart) {
//        heart.setHeartCount(heart);
...
//        postingRepository.saveAndFlush(posting);
//
//        Heart heart = Heart.builder().heartId(1L).user(user).posting(posting).heartCnt(0L).build();
//
...
//        }
//        latch.await();
//        Heart heart1 = heartRepository.findById(1L).get();
//        assertThat(heart1.getHeartCnt()).isEqualTo(100L);
//    }
}
